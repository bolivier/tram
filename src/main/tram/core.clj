...
(defn generate-config
  ...
  {:project/name         project-name
   :database/test        {:store :database
                          :migration-dir "migrations/"
                          :migration-table-name "migrations"
                          :db {:dbtype "postgresql"
                               :dbname (str project-name "_test")}}
   :database/development {:store :database
                          :migration-dir "migrations/"
                          :migration-table-name "migrations"
                          :db {:dbtype "postgresql"
                               :dbname (str project-name "_development")}}
   :database/prod        {:store :database
                          :migration-dir "migrations/"
                          :migration-table-name "migrations"
                          :db {:dbtype "postgresql"
                               :dbname (str project-name "_production")}}})
